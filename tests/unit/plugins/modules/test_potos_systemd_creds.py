...
"""Unit tests for the ``potos.base.potos_systemd_creds`` argv helpers."""
...
_MODULE_PATH = (
    Path(__file__).resolve().parents[4] / "plugins" / "modules" / "potos_systemd_creds.py"
)
_spec = importlib.util.spec_from_file_location("potos_systemd_creds_under_test", _MODULE_PATH)
