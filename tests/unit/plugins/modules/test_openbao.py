...
"""Unit tests for the ``projectpotos.base.openbao`` argv/parse helpers."""
...
_MODULE_PATH = Path(__file__).resolve().parents[4] / "plugins" / "modules" / "openbao.py"
_spec = importlib.util.spec_from_file_location("openbao_under_test", _MODULE_PATH)
