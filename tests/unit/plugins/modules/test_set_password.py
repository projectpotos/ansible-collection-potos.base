...
"""Unit tests for the ``projectpotos.base.set_password`` module helpers."""
...
_MODULE_PATH = Path(__file__).resolve().parents[4] / "plugins" / "modules" / "set_password.py"
_spec = importlib.util.spec_from_file_location("set_password_under_test", _MODULE_PATH)
