...
"""Unit tests for the ``potos.base.potos_luks`` helpers."""
...
_MODULE_PATH = Path(__file__).resolve().parents[4] / "plugins" / "modules" / "potos_luks.py"
_spec = importlib.util.spec_from_file_location("potos_luks_under_test", _MODULE_PATH)
